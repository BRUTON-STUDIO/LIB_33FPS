...
local Library = {
	...
	Themes = {
    Default = {
            Main = Color3.fromRGB(6, 16, 10),
			Second = Color3.fromRGB(10, 24, 16),
			Stroke = Color3.fromRGB(40, 140, 75),
			Divider = Color3.fromRGB(35, 65, 45),
...
function Library:MakeWindow(WindowConfig)
	...
	WindowConfig.IntroToggleIcon = WindowConfig.IntroToggleIcon or "rbxassetid://138706873816984"
...
local ResizeBtn = SetChildren(SetProps(MakeElement("Button"), {
	...
	local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		SetChildren(SetProps(MakeElement("TFrame"), {
			...
			AddThemeObject(SetProps(MakeElement("Label", "By BRUTON HUB", 12), {
...
MakeResizable(ResizeBtn, MainWindow, Vector2.new(400, 250), Vector2.new(1200, 800), SetResizingCallback)
	...
	function TabFunction:MakeTab(TabConfig)
		...
		if FirstTab then
			...
			TabFrame.Ico.ImageColor3 = Color3.fromRGB(57, 255, 106)
			TabFrame.Title.TextColor3 = Color3.fromRGB(57, 255, 106)
