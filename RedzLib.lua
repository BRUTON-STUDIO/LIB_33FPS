local Configs_HUB = {
  Cor_Hub = Color3.fromRGB(14, 14, 14),
...
function MakeWindow(Configs)
  ...
  function AddButton(parent, Configs)
    ...
    local TextButton = Create("TextButton", parent, {
      ...
      Text = "",
      AutoButtonColor = false
    })Corner(TextButton)Stroke(TextButton, {Transparency = 0.7})
  ...
  function AddToggle(parent, Configs)
    ...
    local Stroke = Stroke(Frame1, {Thickness = 1, Transparency = 0.6})
...
if Default then
    OnOff = true
    CreateTween(Frame2, "Position", UDim2.new(1, -15, 0.5, 0), 0.2, false)
    CreateTween(Frame1, "BackgroundColor3", Color3.fromRGB(235, 235, 235), 0.2, false)
    CreateTween(Frame2, "BackgroundColor3", Color3.fromRGB(20, 20, 20), 0.2, false)
end
    Callback(OnOff)
TextButton.MouseButton1Click:Connect(function()
    if not OnOff then
        ...
        CreateTween(Frame1, "BackgroundColor3", Color3.fromRGB(50, 50, 50), 0.2, false)
  ...
  function UpdateToggle(toggle, value)
    ...
    if OnOff then
      ...
      CreateTween(Frame2, "BackgroundColor3", Color3.fromRGB(235, 235, 235), 0.2, false)
      CreateTween(Stroke, "Color", Color3.fromRGB(235, 235, 235), 0.2, false)
  ...
  function AddSlider(parent, Configs)
    ...
    local Frame = Create("TextButton", parent, {
      ...
      Name = "Frame",
      Text = 0
    })Corner(Frame)Stroke(Frame, {Transparency = 0.7})
  ...
  function AddParagraph(parent, Configs)
    ...
    local Frame = Create("Frame", parent, {
      ...
      Name = "Frame",
      AutomaticSize = "Y"
    })Corner(Frame)Stroke(Frame, {Transparency = 0.7})Create("UIListLayout", Frame)Create("UIPadding", Frame, {
